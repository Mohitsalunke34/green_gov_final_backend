...
public final class AuditMapper {
	...
	// New enriched method (overloaded)
	public static AuditResponseDTO toDTO(Audit audit, String complianceLabel) {

		AuditResponseDTO dto = toDTO(audit); // reuse old method

		dto.setComplianceLabel(complianceLabel);
